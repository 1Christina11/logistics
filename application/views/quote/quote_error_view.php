...
<!-- Start of Breadcrumb section
	============================================= -->
	<section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="<?php echo base_url()?>/assets/img/bg/bread-bg.jpg">
		<span class="background_overlay"></span>
		<span class="design-shape position-absolute"><img src="<?php echo base_url()?>assets/img/shape/tmd-sh.png" alt=""></span>
		<div class="container">
...
<!-- Start of contact page section
	============================================= -->
<section id="ft-contact" class="ft-contact-section position-relative" data-background="<?php echo base_url()?>assets/img/bg/c-bg.jpg">
		<div class="container">
			<div class="ft-contact-content">
				<div class="ft-section-title headline pera-content">
					...
					<p>there has been an error to your quote</p>s
				</div>
			</div>
		</div>
	</section>

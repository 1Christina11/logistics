			...
			<div class="col-md-10">
				<div class="card">
					...
					<div class="card-header" align="center">
						...
						<form action="<?php echo site_url('Log/log_result_view')?>" method="post">
					...
					<div class="card-header" align="center">
						...
						<span class="d-block m-t-5"><code>Optional</code></span>
							...
							<div class="row form-group">
								<div class="col-sm-4">
									<label class="col-form-label" for="user_id">Member name</label>
								</div>
								<div class="col-sm-8">
									<select class="form-control" id="user_id" name="user_id">
										<option value=""></option>
										<option value="user_id">name from user id</option>
									</select>
								</div>
							</div>
							<!-- [ Impotancem ] end -->

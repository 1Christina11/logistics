				...
				<div class="col-md-12">
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<label class="floating-label" for="first_name">first_name</label>
							<input type="text" class="form-control" id="first_name" placeholder="">
						</div>
						<div class="form-group mb-3">
							<label class="floating-label" for="last_name">last_name</label>
							<input type="text" class="form-control" id="last_name" placeholder="">
						</div>
						<div class="form-group mb-3">
							<label class="floating-label" for="mobile_no">mobile_no</label>
							<input type="text" class="form-control" id="mobile_no" placeholder="">
						</div>

						<div class="form-group mb-3">
							<label class="floating-label" for="passwoed">passwoed</label>
							<input type="text" class="form-control" id="passwoed" placeholder="">
						</div>
				    	<div class="form-group mb-3">
							<label class="floating-label" for="e_mail">e_mail</label>
							<input type="text" class="form-control" id="e_mail" placeholder="">
						</div>
						<div class="form-group mb-3">
						...
						<div class="form-group mb-3">
							<label class="floating-label" for="birthdata">birthdata</label>
							<input type="text" class="form-control" id="birthdata" placeholder="">
						</div>
						<div class="form-group mb-3">
							<label class="floating-label" for="qualification_degree">qualification_degree</label>
							<input type="text" class="form-control" id="qualification_degree" placeholder="">
						</div>
						<div class="form-group mb-3">

          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-push-3">
                ...
                <h4 class="text-theme-colored mt-0 pt-5">Forgot your password?</h4>
                <form name="login-form" class="form-transparent clearfix">
                  <div class="row">
                    <div class="form-group col-md-12">
					  <h3>Enter your registered e-mail please</h3>
                      <label for="form_email">E-mail</label>
                      <input disabled id="form_email" name="email" class="form-control" type="email">
                    </div>
                  </div>
                  <div class="form-group pull-right mt-10">
                    <button type="submit" class="btn btn-dark btn-sm">Send a reset password request</button>
                  </div>
                </form>
              </div>
            </div>

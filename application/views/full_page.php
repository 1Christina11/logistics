...
<head>
	...
	<link rel="shortcut icon" href="<?php echo base_url()?>assets/img/logo/ficon.png" type="image/x-icon">
			...
			<div class="ft-header-content position-relative">
				...
				<div class="ft-header-main-menu d-flex align-items-center justify-content-between">
					<div class="ft-brand-logo">
						<a href="#"><img src="<?php echo base_url()?>assets/img/logo/logo5.png" alt=""></a>
					</div>
					<div class="ft-header-main-menu-cta  d-flex align-items-center">
						<nav class="ft-main-navigation clearfix ul-li">
							<ul id="ft-main-nav" class="nav navbar-nav clearfix">
								...
								<li><a href="<?php echo site_url()?>/About_us/index">About</a></li>
								<li class="dropdown">
								...
								<li class="dropdown">
									<a href="!.html#">Others</a>
									<ul class="dropdown-menu clearfix">
										<li><a href="team.html">Team Page </a></li>
										<li><a href="team-single.html">Team  Details </a></li>
										<li><a href="coming-soon.html">Coming Soon</a></li>
										<li><a href="<?php echo site_url()?>/Contact_us/insert_view/">Contact Us</a></li>
									</ul>
								</li>
							</ul>
						</nav>
					...
					<div class="mobile_menu_wrap">
						...
						<div class="mobile_menu_content">
							...
							<div class="m-brand-logo">
								<a href="!.html#"><img src="<?php echo base_url()?>assets/img/logo/logo4.png" alt=""></a>
							</div>
								...
								<ul id="m-main-nav" class="navbar-nav text-capitalize clearfix">
									...
									<li class="dropdown">
										...
										<ul class="dropdown-menu clearfix">
											...
											<li><a href="<?php echo site_url()?>/Contact_us/get_contact_us">Contact Page</a></li>
	...
	<section id="ft-slider-3" class="ft-slider-section-3">		
		<rs-module-wrap id="rev_slider_29_1_wrapper" data-alias="slider-8" data-source="gallery" style="visibility:hidden;background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
			<rs-module id="rev_slider_29_1" style="" data-version="6.5.8">
				<rs-slides>
					<rs-slide style="position: absolute;" data-key="rs-76" data-title="Slide" data-thumb="<?php echo base_url()?>assets/slider1-50x100.png" data-in="o:0;" data-out="a:false;">
						<img src="<?php echo base_url()?>assets/slider1.png" alt="img" title="slider1" width="1920" height="989" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
--><rs-layer
...
>We specialise in the transportation 
							...
							data-frame_999="o:0;st:w;"
							style="z-index:9;"
							><img src="<?php echo base_url()?>assets/s-truck-1.png" alt="Img" class="tp-rs-img" width="1034" height="599" data-no-retina> 
							</rs-layer><!--
							-->						</rs-slide>
							<rs-slide style="position: absolute;" data-key="rs-77" data-title="Slide" data-thumb="<?php echo base_url()?>assets/slider1-50x100.png" data-in="o:0;" data-out="a:false;">
								<img src="<?php echo base_url()?>assets/slider1.png" alt="img" title="slider1" width="1920" height="989" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
--><rs-layer
...
>We specialise in the transportation 
							...
							-->						</rs-slide>
							<rs-slide style="position: absolute;" data-key="rs-78" data-title="Slide" data-thumb="<?php echo base_url()?>assets/slider1-50x100.png" data-in="o:0;" data-out="a:false;">
								<img src="<?php echo base_url()?>assets/slider1.png" alt="img" title="slider1" width="1920" height="989" class="rev-slidebg tp-rs-img" data-no-retina>
<!--
--><rs-layer
				...
				<div class="ft-service-content-items-3">
					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							<div class="ft-service-innerbox-3 position-relative">
								<div class="ft-service-img position-relative">
									<img src="<?php echo base_url()?>assets/img/service/ser4.jpg" alt="">
								</div>
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
							<div class="ft-service-innerbox-3 position-relative">
								<div class="ft-service-img position-relative">
									<img src="<?php echo base_url()?>assets/img/service/ser6.jpg" alt="">
								</div>
								<div class="ft-service-text-icon position-relative">
									<div class="ft-service-icon d-flex align-items-center justify-content-center position-absolute">
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
							<div class="ft-service-innerbox-3 position-relative">
								<div class="ft-service-img position-relative">
									<img src="<?php echo base_url()?>assets/img/service/ser8.jpg" alt="">
								</div>
								<div class="ft-service-text-icon position-relative">
									<div class="ft-service-icon d-flex align-items-center justify-content-center position-absolute">
					...
					<div class="col-lg-6 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="ft-about-img-wrapper-3 position-relative">
							<div class="ft-about-img-3">
								<img src="<?php echo base_url()?>assets/img/about/ab2.png" alt="">
							</div>
							<div class="ft-about-sign-img-text">
								<span class="sign-shape"><img src="<?php echo base_url()?>assets/img/shape/sign-sh.png" alt=""></span>
								<div class="ft-about-sign-img">
									<img src="<?php echo base_url()?>assets/img/about/sign.png" alt="">							
								</div>
		...
		<div class="ft-case-study-content d-flex">
			<div class="ft-case-study-items position-relative">
				<div class="ft-case-study-img position-relative">
					<img src="<?php echo base_url()?>assets/img/project/cs1.jpg" alt="">
				</div>
			...
			<div class="ft-case-study-items position-relative">
				<div class="ft-case-study-img position-relative">
					<img src="<?php echo base_url()?>assets/img/project/cs2.jpg" alt="">
				</div>
				<div class="ft-case-study-text headline pera-content">
			...
			<div class="ft-case-study-items position-relative">
				<div class="ft-case-study-img position-relative">
					<img src="<?php echo base_url()?>assets/img/project/cs3.jpg" alt="">
				</div>
				<div class="ft-case-study-text headline pera-content">
			...
			<div class="ft-case-study-items position-relative">
				<div class="ft-case-study-img position-relative">
					<img src="<?php echo base_url()?>assets/img/project/cs4.jpg" alt="">
				</div>
				<div class="ft-case-study-text headline pera-content">
...
<!-- Start of Fun fact section
	============================================= -->
	<section id="ft-funfact-2" class="ft-funfact-section-2" data-background="<?php echo base_url()?>assets/img/bg/shape-bg.jpg">
		<div class="container">
			...
			<div class="ft-funfact-content-2 position-relative">
				<span class="map-bg position-absolute text-center"><img src="<?php echo base_url()?>assets/img/bg/map.png" alt=""></span>
...
<!-- Start of why choose us section
	...
	<section id="ft-why-choose-2" class="ft-why-choose-section-2 position-relative">
		<span class="why-choose-bg-2"><img src="<?php echo base_url()?>assets/img/bg/wc-bg2.jpg" alt=""></span>
		<span class="why-choose-img-2 position-absolute wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms"><img src="<?php echo base_url()?>assets/img/about/ab3.png" alt=""></span>
		<div class="container">
							...
							<div class="ft-why-choose-form pera-content">
								<form action="#">
									<div class="row">
										...
										<div class="col-md-12">
											<div class="wc-input-range" data-background="<?php echo base_url()?>assets/img/bg/wc-f-bg.jpg">
			...
			<div class="ft-testimonial-content-3">
				<div class="ft-testimonial-slider-wrapper-3 d-flex">
					<div class="ft-testimonial-slider-img">
						<img src="<?php echo base_url()?>assets/img/testimonial/tst-bg.jpg" alt="">
					</div>
			...
			<div class="ft-blog-content-3">
				<div class="blog-slider-3">
					<div class="ft-item-innerbox">
						<div class="ft-blog-innerbox-3 position-relative">
							<div class="ft-blog-img">
								<img src="<?php echo base_url()?>assets/img/blog/blg3.3.jpg" alt="">
							</div>
					...
					<div class="ft-item-innerbox">
						<div class="ft-blog-innerbox-3 position-relative">
							<div class="ft-blog-img">
								<img src="<?php echo base_url()?>assets/img/blog/blg3.4.jpg" alt="">
							</div>
							<div class="ft-blog-text headline pera-content position-relative">
								<div class="ft-blog-meta d-flex justify-content-between">
									<a href="#"><i class="fas fa-calendar-alt"></i> September 12, 2019</a>
					...
					<div class="ft-item-innerbox">
						<div class="ft-blog-innerbox-3 position-relative">
							<div class="ft-blog-img">
								<img src="<?php echo base_url()?>assets/img/blog/blg3.5.jpg" alt="">
							</div>
							<div class="ft-blog-text headline pera-content position-relative">
								<div class="ft-blog-meta d-flex justify-content-between">
									<a href="#"><i class="fas fa-calendar-alt"></i> September 12, 2019</a>
...
<!-- Start Of Footer section
	============================================= -->
	<footer id="ft-footer-3" class="ft-footer-section-3" data-background="<?php echo base_url()?>assets/img/bg/f-bg3.jpg">
							...
							<div class="ft-footer-widget ul-li-block headline pera-content">
								<div class="gallery-widget clearfix">
									...
									<ul class="zoom-gallery">
										<li><a href="<?php echo base_url()?>assets/img/gallery/gl1.jpg" data-source="<?php echo base_url()?>assets/img/gallery/gl1.jpg"><img src="<?php echo base_url()?>assets/img/gallery/gl1.jpg" alt=""></a></li>
										<li><a href="<?php echo base_url()?>assets/img/gallery/gl2.jpg" data-source="<?php echo base_url()?>assets/img/gallery/gl2.jpg"><img src="<?php echo base_url()?>assets/img/gallery/gl2.jpg" alt=""></a></li>
										<li><a href="<?php echo base_url()?>assets/img/gallery/gl3.jpg" data-source="<?php echo base_url()?>assets/img/gallery/gl3.jpg"><img src="<?php echo base_url()?>assets/img/gallery/gl3.jpg" alt=""></a></li>
										<li><a href="<?php echo base_url()?>assets/img/gallery/gl4.jpg" data-source="<?php echo base_url()?>assets/img/gallery/gl4.jpg"><img src="<?php echo base_url()?>assets/img/gallery/gl4.jpg" alt=""></a></li>
										<li><a href="<?php echo base_url()?>assets/img/gallery/gl5.jpg" data-source="<?php echo base_url()?>assets/img/gallery/gl4.jpg"><img src="<?php echo base_url()?>assets/img/gallery/gl5.jpg" alt=""></a></li>
										<li><a href="<?php echo base_url()?>assets/img/gallery/gl6.jpg" data-source="<?php echo base_url()?>assets/img/gallery/gl4.jpg"><img src="<?php echo base_url()?>assets/img/gallery/gl6.jpg" alt=""></a></li>
									</ul>
								</div>
							</div>
						</div>

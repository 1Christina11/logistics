...
-      /*PREFERENCES STYLE*/
    ...
    .form-all:before {
      content: "";
      background-image: url("https://www.jotform.com/uploads/seyma/form_files/logo.5f325c56f27905.40860751.png");
...
<section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="assets/img/bg/bread-bg.jpg">
    ...
    <div class="ft-contact-page-form-wrapper headline">
							<h3 class="text-center">Your Email Sent UnSuccessfuly</h3>
    </div>
</section>
